...
func (a *ABitOfEverythingApiService) ABitOfEverythingServiceUpdateBook(ctx context.Context, body TheBookToUpdate_, bookName string, localVarOptionals *ABitOfEverythingApiABitOfEverythingServiceUpdateBookOpts) (ExamplepbBook, *http.Response, error) {
	var (
